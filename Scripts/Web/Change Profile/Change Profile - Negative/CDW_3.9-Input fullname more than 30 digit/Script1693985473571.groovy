...
WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Dashboard/input_Phone_whatsapp'), 'qwertyuiopasdfghjklzxcvbnmqwerty')

WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Dashboard/button_Save Changes'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Coding.ID - Dashboard/strong_The name may not be greater than 30 _ae5806'), 
