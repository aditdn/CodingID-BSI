...
WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Dashboard/input_Phone_whatsapp'), '6123456789121')

WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Dashboard/button_Save Changes'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Coding.ID - Dashboard/strong_The whatsapp must be between 10 and _22356d'), 
