...
WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Dashboard/img'))

WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Dashboard/img_Invoice_avatar-icon'))
