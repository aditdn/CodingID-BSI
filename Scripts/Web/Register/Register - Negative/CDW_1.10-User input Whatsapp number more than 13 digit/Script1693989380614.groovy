...
WebUI.setText(findTestObject('Page_Buat akun dan dapatkan akses di Coding.ID/Field-Tanggal lahir'), '29-Mar-2000')

WebUI.setText(findTestObject('Page_Buat akun dan dapatkan akses di Coding.ID/Field_E-Mail'), 'contoh@mail.com')

WebUI.setText(findTestObject('Page_Buat akun dan dapatkan akses di Coding.ID/Field-Whatsapp'), '1234567812345678')
